...
const AllowBrowserPermission = () => {
  return (
    <p className="text-sm">
      Please grant your broswer permission to access your camera and microphone.
    </p>
  );
};
...
export const CallLobby = ({ onJoin }: Props) => {
  ...
  const hasBrowserMedaiPermission = hasCamPermission && hasMicPermission;
